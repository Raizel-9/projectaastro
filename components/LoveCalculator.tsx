...
const LoveCalculator: React.FC<LoveCalculatorProps> = ({ profile, goBack }) => {
    ...
    return (
        <div className="bg-gray-900/50 backdrop-blur-sm border border-purple-400/30 rounded-lg p-6 shadow-lg shadow-purple-900/50 animate-fade-in space-y-6">
            <div className="text-center">
                ...
                <h2 className="text-3xl font-bold font-cinzel text-red-400 mt-2">Love Calculator</h2>
            ...
            {compatibilityData && !loading && (
                <div className="text-center animate-fade-in p-4 bg-gray-800/30 rounded-lg space-y-4">
                    <div>
                        <p className="text-lg text-gray-400">Your Love Score</p>
                    ...
                    <div className="mt-6 flex justify-center">
                         <button onClick={() => setCompatibilityData(null)} className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded transition-colors duration-300">Calculate Another</button>
                    </div>
                </div>
            )}
